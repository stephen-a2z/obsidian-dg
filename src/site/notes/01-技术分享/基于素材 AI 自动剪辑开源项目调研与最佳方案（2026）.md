---
{"dg-publish":true,"permalink":"/01-技术分享/基于素材 AI 自动剪辑开源项目调研与最佳方案（2026）/","tags":["AI","视频剪辑","自动化","开源项目","短视频","混剪","AIGC","ComfyUI"],"noteIcon":"","created":"2026-06-16T01:48:57.286+08:00","updated":"2026-06-17T01:33:51.270+08:00"}
---
...
| 项目 | ⭐Stars | 语言 | 定位 | 关键特性 |
|------|---------|------|------|---------|
| [Edit Mind](https://github.com/IliasHad/edit-mind) | 1,600 | TypeScript/Python | 本地视频知识库 & 语义搜索 | YOLO+DeepFace+Whisper 多模态索引，自然语言检索素材，NLE 集成（DaVinci/FCP） |
...
**与其他路线的关系**：Edit Mind 本身不生成或剪辑视频，而是**素材检索基础设施**。它可以作为路线 B（素材混剪）和路线 C（长转短）的**上游工具**——先用 Edit Mind 高效找到目标素材，再用其他工具完成剪辑。
...
*参考项目链接：*
- [Edit Mind](https://github.com/IliasHad/edit-mind) - 本地视频知识库 & 语义搜索
